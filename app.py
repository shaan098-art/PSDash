...
with tabs[0]:
    st.markdown(
        "<h1 style='text-align: center; color: #0D8661; font-size: 2.6rem; font-weight: 700;'>𓌉◯𓇋 Paushtikk Switch: Evolve Everyday!</h1>",
...
Know your highest value subscribers.
    ...
    top10 = (
        ...
        .agg(Total_Spend_in_INR=('Total_Price', 'sum'))
        .sort_values('Total_Spend_in_INR', ascending=False)
        .head(10)
        .reset_index()
    )
